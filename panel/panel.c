...
static void launch_launcher(GtkButton *button, gpointer data) {
    (void)button;
    (void)data;
    pid_t pid = fork();
    if (pid == 0) {
        execl("/home/israfil/Desktop/LIDE/blackline-launcher", "blackline-launcher", NULL);
        exit(0);
    }
}
...
static void activate(GtkApplication *app, gpointer user_data) {
    ...
    g_signal_connect(btn1, "clicked", G_CALLBACK(launch_launcher), NULL);
    ...
    gtk_box_pack_end(GTK_BOX(box), clock, FALSE, FALSE, 5);
