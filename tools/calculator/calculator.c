...

{
    ...
    gtk_css_provider_load_from_data(provider,
        ...
        "label { color: #ffffff; }\n"
        "button { background-image: none; background: #1a1a1a; color: #6d567e; border: 1px solid #6d567e; }\n"
        "button:hover { background: #333333; }\n"
        "#title-bar { background: #000000; border-bottom: 2px solid #6d567e; }\n"
        "frame { border: 2px solid #6d567e; }\n"
        "frame > label { background: #1a1a1a; padding: 10px; font-size: 24px; }\n",
        -1, NULL);
