...
static void activate(GtkApplication *app, gpointer user_data) {
    ...
    gtk_css_provider_load_from_data(provider,
        ...
        "#title-bar { background: #000000; border-bottom: 2px solid #86559a; }"
        "frame { border-color: #86559a; color: #ffffff; }"
        "frame > label { color: #86559a; }"
        "treeview { background: #1a1a1a; color: #ffffff; }"
        "treeview:selected { background: #86559a; color: #000000; }"
        "treeview.view { border-color: #86559a; }"
        "button { background-image: none; background: #1a1a1a; color: #86559a; border: 1px solid #86559a; }"
