...
int main(void) {
    ...
    start_program("/home/israfil/Desktop/LIDE/blackline-wm", &wm_pid);
    if (wm_pid < 0) return 1;

    sleep(1);

    start_program("/home/israfil/Desktop/LIDE/blackline-wallpaper", &wallpaper_pid);

    start_program("/home/israfil/Desktop/LIDE/blackline-panel", &panel_pid);
    if (panel_pid < 0) {
        kill(wm_pid, SIGTERM);
        return 1;
    }
